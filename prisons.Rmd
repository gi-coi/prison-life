...
Each prison receives an inspection at least every 5 years, which means numbers of recommendations are only partly comparable and not statistically significant.
It can be interesting to compare the performance of public vs. private prisons (excluding immigration centres, police custody, etc.)
